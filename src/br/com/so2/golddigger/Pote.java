...
public class Pote {
    ...
    private void populaDestinos() {
        potesDestinos.put(0, Arrays.asList(2, 15));
        potesDestinos.put(1, Arrays.asList(1, 3, 4, 5));
        potesDestinos.put(2, Arrays.asList(2, 9));
        ...
        potesDestinos.put(16, Arrays.asList(11, 16));
        potesDestinos.put(17, Arrays.asList(9, 16, 19));
        potesDestinos.put(18, Arrays.asList(18, 20));
        potesDestinos.put(19, Arrays.asList(16, 19));
    }
